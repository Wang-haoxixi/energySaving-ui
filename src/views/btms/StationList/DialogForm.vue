<template>
  <iep-dialog :dialog-show="dialogShow" :title="`岗位${methodName}`" width="480px" @close="loadPage">
    <el-form class="form-detail" :model="form" ref="form" :rules="rules" label-width="95px">
      <iep-form-item class="form-half" label-name="岗位名称" prop="name">
        <el-input v-model="form.name"></el-input>
      </iep-form-item>
      <el-form-item class="form-half" label-name="岗位等级" prop="type">
        <el-input v-model="form.type" disabled></el-input>
      </el-form-item>
      <iep-form-item label-name="岗位说明" prop="introduction">
...
import { getPageDetailById } from "@/api/dms/position";
