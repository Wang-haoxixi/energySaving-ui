<template>
  <div>
    <div v-show="pageState === 'list'">
      <iep-basic-container>
        <iep-page-header title="数据流程配置"></iep-page-header>
        <div style="width:100%;">
          ...
          <el-table-column prop="operation" label="操作" width="200">
            <template slot-scope="scope">
              <iep-operation-wrapper>
                ...
                <el-button type="text" @click="flow(scope.row)">流程图</el-button>
              </iep-operation-wrapper>
            </template>
          </el-table-column>
        </iep-table>
    ...
    <flow-pic ref="flow" v-if="pageState === 'flow'" @load-page="backPage"></flow-pic>
  </div>
</template>
<script>
...
import flowPic from "./flow";
export default {
  mixins: [mixins],
  components: { FormTpl, flowPic },
  data() {
    return {
      columnsMap: [
        {
