<template>
  <div class="iep-page-form">
    ...
    >
      <el-form-item label="数据元中文名称：" prop="commonDataMetaName" class="half-line">
        <el-input v-model="formData.commonDataMetaName" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="数据元英文名称：" prop="commonDataMetaNameEn" class="half-line">
        <el-input v-model="formData.commonDataMetaNameEn" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="数据元标识符：" prop="commonDataMetaNumber" class="half-line">
        <el-input v-model="formData.commonDataMetaNumber" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="表示：" prop="commonDataMetaValue" class="half-line">
        <el-input v-model="formData.commonDataMetaValue" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="说明：" prop="commonDataMetaDescription">
        <el-input v-model="formData.commonDataMetaDescription" maxlength="500" type="textarea"></el-input>
      </el-form-item>
      <el-form-item label="标准文件名称：" prop="govStandardDocumentsId">
