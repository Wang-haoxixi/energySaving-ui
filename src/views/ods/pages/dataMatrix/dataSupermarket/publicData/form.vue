<template>
  <div class="iep-page-form">
    ...
    >
      <el-form-item label="分类代码：" prop="categoryCode" class="half-line">
        <el-input v-model="formData.categoryCode" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="分类名称：" prop="categoryName" class="half-line">
        <el-input v-model="formData.categoryName" maxlength="150"></el-input>
      </el-form-item>
    </el-form>
