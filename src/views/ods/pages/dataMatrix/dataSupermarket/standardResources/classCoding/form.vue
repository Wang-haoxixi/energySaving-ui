<template>
  <div class="iep-page-form">
    ...
    >
      <el-form-item label="分类代码：" prop="classificationCode" class="half-line">
        <el-input v-model="formData.classificationCode" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="分类名称：" prop="classificationName" class="half-line">
        <el-input v-model="formData.classificationName" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="说明：" prop="remark">
        <el-input v-model="formData.remark" maxlength="500" type="textarea"></el-input>
      </el-form-item>
