<template>
  <div class="iep-page-form" style="padding: 20px 10%;">
    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="预审基本信息" name="first">
        <h1>项目概况</h1>
        <hr />
        <el-form
          ref="form"
      ...
      <el-tab-pane label="预审文档信息" name="second">暂时没有文档内容！</el-tab-pane>
      <el-tab-pane label="预审过程信息" name="third">
        <el-timeline>
          <el-timeline-item timestamp="2019-12-30 17:01:55" placement="top">
            <h4>项目申报</h4>
            <p>部门:市教育局</p>
            <p>流程节点处理人:管理员(gmhy)</p>
          </el-timeline-item>
          <el-timeline-item timestamp="2019-12-30 17:33:55" placement="top">
            <h4>项目申报</h4>
            <p>部门:市教育局</p>
            <p>流程节点处理人:管理员(gmhy)</p>
          </el-timeline-item>
          <el-timeline-item timestamp="2019-12-30 17:55:55" placement="top">
            <h4>项目申报</h4>
            <p>部门:市教育局</p>
            <p>流程节点处理人:管理员(gmhy)</p>
          </el-timeline-item>
      ...
      <el-tab-pane label="预审评分信息" name="fourth">
        <img src="./const/pic.png" />
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
