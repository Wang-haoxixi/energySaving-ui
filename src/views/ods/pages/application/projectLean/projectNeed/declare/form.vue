  ...
  <div class="iep-page-form">
    ...
    <div style="padding: 5px 10%;">
      <el-steps :active="active">
        <el-step title="项目概况" icon="el-icon-edit"></el-step>
        <el-step title="项目背景" icon="el-icon-edit"></el-step>
        <el-step title="项目建设" icon="el-icon-edit"></el-step>
        <el-step title="技术方案" icon="el-icon-edit"></el-step>
        <el-step title="项目预算" icon="el-icon-edit"></el-step>
        <el-step title="项目收益" icon="el-icon-edit"></el-step>
      </el-steps>
    </div>
    <div v-if="active === 0">
      <h1>项目概况</h1>
      <hr>
      <el-form ref="form" :model="form" label-width="150px" style="padding: 20px 5%;">
        ...
        <el-form-item label="项目开始年度:">
            <el-date-picker type="date" placeholder="请输入项目开始年度" v-model="form.date1" style="width: 100%;"></el-date-picker>
        </el-form-item>
        <el-form-item label="项目结束年度:">
            <el-date-picker type="date" placeholder="请输入项目结束年度" v-model="form.date2" style="width: 100%;"></el-date-picker>
        </el-form-item>
    ...
    <div v-if="active === 5">
      ...
      <hr>
      <el-form ref="form" :model="form" label-width="150px" style="padding: 20px 5%;">
          <el-form-item label="政府部门(个):">
            已选5（市本级部门3个，区县市2个，开放区0个）
          </el-form-item>
      ...
      <div style="text-align: right">
        <el-button type="primary" @click="submitForm" :loading="loadState">{{active === 5 ? '提交' :'下一步'}}</el-button>
        <iep-button @click="resetForm">保存草稿</iep-button>
      </div>
  </div>
</template>
<script>
