<template>
  <div>
    <div v-show="pageState === 'list'">
      <iep-basic-container>
        <iep-page-header title="重置责任部门"></iep-page-header>
        <div style="width:100%;">
        ...
        >
          ...
          <template #overallConfirm="{scope}">
            <el-button size="small" @click="handleRemark(scope.row)" type="text">重新标记数源部门</el-button>
          </template>
        </iep-table>
      </iep-basic-container>
    </div>
