<template>
  <div class="iep-page-form">
    ...
    >
      <el-form-item label="门类代码:" prop="commonDataMetaName" class="half-line">
        <el-input v-model="formData.commonDataMetaName" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="门类名称:" prop="commonDataMetaNameEn" class="half-line">
        <el-input v-model="formData.commonDataMetaName5" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="说明:" prop="commonDataMetaNumber" class="half-line">
        <el-input v-model="formData.commonDataMetaName6" maxlength="150"></el-input>
      </el-form-item>
    </el-form>
