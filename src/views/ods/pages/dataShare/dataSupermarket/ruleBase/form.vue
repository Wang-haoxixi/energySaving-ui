<template>
  <div class="iep-page-form">
    ...
    >
      <el-form-item label="规则标识符:" prop="commonDataMetaName" class="half-line">
        <el-input v-model="formData.commonDataMetaName" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="规则中文名称:" prop="commonDataMetaNameEn" class="half-line">
        <el-input v-model="formData.commonDataMetaNameEn" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="规则英文名称:" prop="commonDataMetaNumber" class="half-line">
        <el-input v-model="formData.commonDataMetaNumber" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="说明：" prop="commonDataMetaValue" class="half-line">
        <el-input v-model="formData.content" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="所属元数据：" class="half-line">
        {{ formData.belongingData }}
      </el-form-item>
      <el-form-item label="标准文件名称：" class="half-line">
        <el-input v-model="formData.standardDocuments" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="标准号："  class="half-line">
        {{ formData.StandardNo }}
      </el-form-item>
      <el-form-item label="版本(年代)号："  class="half-line">
        {{ formData.versionNo }}
      </el-form-item>
      <el-form-item label="ICS编码："  class="half-line">
        {{ formData.ics }}
      </el-form-item>
      <el-form-item label="CCS编码："  class="half-line">
        {{ formData.css }}
      </el-form-item>
      <el-form-item label="发布机构：" class="half-line">
        {{ formData.issuedBy }}
      </el-form-item>
    </el-form>
