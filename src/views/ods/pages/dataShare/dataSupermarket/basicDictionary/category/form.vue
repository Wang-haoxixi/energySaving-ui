<template>
  <div class="iep-page-form">
    ...
    >
      ...
      <el-form-item label="范畴号1:" prop="commonDataMetaNameEn" class="half-line">
        <el-input v-model="formData.commonDataMetaNameEn" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="范畴号2:" prop="commonDataMetaNumber" class="half-line">
        <el-input v-model="formData.commonDataMetaNumber" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="范畴号3：" prop="commonDataMetaValue" class="half-line">
        <el-input v-model="formData.commonDataMetaValue" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="中办/国办：" prop="govStandardDocumentsId">
