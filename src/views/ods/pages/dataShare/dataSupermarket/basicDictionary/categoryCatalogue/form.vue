<template>
  <div class="iep-page-form">
    ...
    >
      <el-form-item label="范畴等级:" prop="commonDataMetaName" class="half-line">
        <el-input v-model="formData.commonDataMetaNumber" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="范畴号:" prop="commonDataMetaNameEn" class="half-line">
        <el-input v-model="formData.commonDataMetaName" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="范畴名:" prop="commonDataMetaNumber" class="half-line">
