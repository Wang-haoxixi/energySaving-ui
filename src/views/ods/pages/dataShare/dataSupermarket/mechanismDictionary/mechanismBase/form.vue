<template>
  <div class="iep-page-form">
    ...
    >
      <el-form-item label="机构代码:" prop="commonDataMetaName" class="half-line">
        <el-input v-model="formData.commonDataMetaName" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="机构名称:" prop="commonDataMetaNameEn" class="half-line">
        <el-input v-model="formData.commonDataMetaNameEn" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="机构级别:" prop="commonDataMetaName1" class="half-line">
        <el-input v-model="formData.commonDataMetaName1" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="是否出自标准文件：" prop="commonDataMetaNumber" class="half-line">
        <el-input v-model="formData.commonDataMetaNumber" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="编码机构：" prop="commonDataMetaValue">
