<template>
  <div>
    <div v-show="pageState === 'list'">
      <iep-basic-container>
        <iep-page-header title="目录注册"></iep-page-header>
        <div style="width:100%;">
          ...
          <el-table-column prop="operation" label="操作" width="200">
            <template slot-scope="scope">
              <iep-operation-wrapper>
                <el-button type="text" @click="handleDetail(scope.row)">审核</el-button>
              </iep-operation-wrapper>
            </template>
          </el-table-column>
        </iep-table>
  ...
  data() {
    return {
      columnsMap: [
        ...
        {
          label: "归集状态",
          prop: "govStandardDocumentsId1",
        },
        {
          label: "状态",
          prop: "govStandardDocumentsId2",
        },
      ],
      mockData: mockData,
      pageState: "list",
