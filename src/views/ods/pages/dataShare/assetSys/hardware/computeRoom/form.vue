<template>
  <div class="iep-page-form">
    ...
    >
      <el-form-item label="机房名称:" prop="commonDataMetaName" class="half-line">
        <el-input v-model="formData.commonDataMetaName" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="所属单位:" prop="commonDataMetaNameEn" class="half-line">
        <el-input v-model="formData.commonDataMetaNameEn" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="资产位置:" prop="commonDataMetaNumber" class="half-line">
        <el-input v-model="formData.commonDataMetaNumber" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="负责人：" prop="commonDataMetaValue" class="half-line">
        <el-input v-model="formData.commonDataMetaValue" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="联系方式：" prop="govStandardDocumentsId">
        <el-input v-model="formData.govStandardDocumentsId" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="重要程度：" prop="govStandardDocumentsId">
        <el-input v-model="formData.govStandardDocumentsId" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="资产使用状态：" prop="govStandardDocumentsId">
        <el-input v-model="formData.govStandardDocumentsId" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="相关文档：" prop="govStandardDocumentsId">
        <el-input v-model="formData.govStandardDocumentsId" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="备注：" prop="govStandardDocumentsId">
        <el-input v-model="formData.govStandardDocumentsId" maxlength="150"></el-input>
      </el-form-item>
    </el-form>
