<template>
  <div class="iep-page-form">
    ...
    >
      <el-form-item label="通讯设备名称:" prop="name" class="half-line">
      ...
      <el-form-item label="所属实体服务器：" prop="entityServer" class="half-line">
        <el-input v-model="formData.entityServer" maxlength="150"></el-input>
      </el-form-item>
