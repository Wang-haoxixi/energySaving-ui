<template>
  <div class="iep-page-form">
    ...
    >
      <el-form-item label="政策适用地区名称:" prop="commonDataMetaName" class="half-line">
        <el-input v-model="formData.commonDataMetaName" maxlength="150"></el-input>
      </el-form-item>
      <el-form-item label="识别码:" prop="company" class="half-line">
        <el-input v-model="formData.num" maxlength="150"></el-input>
      </el-form-item>
