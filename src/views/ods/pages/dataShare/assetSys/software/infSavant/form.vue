<template>
  <div class="iep-page-form">
    ...
    >
      <el-form-item label="中间件名称：" prop="name" class="half-line">
      ...
      <el-form-item label="中间件类型:" prop="savantMold" class="half-line">
        <el-select v-model="formData.savantMold" class="full-width">
          <el-option
            v-for="item in savantMoldDict"
            :label="item.label"
            :value="item.value"
            :key="item.value"
          ></el-option>
...
export default {
  ...
  data() {
    return {
      ...
      savantMoldDict: [
        { label: "Weblogic", value: "1" },
        { label: "Websphere", value: "2" },
        { label: "Jboss", value: "3" },
        { label: "Tomcat", value: "4" },
        { label: "Aphche", value: "5" },
        { label: "IIS", value: "6" },
        { label: "Apusic", value: "7" },
        { label: "其他", value: "8" },
      ],
    };
  },
