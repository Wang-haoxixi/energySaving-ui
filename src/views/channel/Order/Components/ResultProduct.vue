  ...
  <div class="order-container">
    ...
    <div class="result-wrap">
      ...
      <div class="detail-wrap">
        ...
        <div class="you-can">
          <span>您可以：</span>
          <span @click="$openPage('/my/index/order')">查看买到的产品</span>
      ...
      <!-- 如果是宝贝支付 -->
      <template v-if="form.paymentMethod === '1'">
        <!-- 是产品 -->
        <Product ref="OrderDetail" v-if="form.type==='1'"></Product>
      </template>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    async loadPage() {
      this.$nextTick(() => {
        this.$refs["OrderDetail"].loadSelf(this.form.id);
      });
    },
  },
};
