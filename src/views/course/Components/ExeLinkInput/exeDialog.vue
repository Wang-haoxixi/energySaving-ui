...
<script>
import { getExeSectionPageByInfoId } from "@/api/qms/exam_exercise";
...
export default {
  ...
  computed: {
    ...
    getExeSectionPage() {
      return getExeSectionPageByInfoId(this.infoId, this.id);
    },
  },
  methods: {
    _close() {
    ...
    load(params = this.searchForm) {
      ...
      this.loadTable(params, this.getExeSectionPage);
    },
