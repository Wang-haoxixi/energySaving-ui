<template>
  <el-dialog title="任务详情" :visible.sync="dialogShow" width="1100px" class="dialog" @close="_close">
    <!-- 头部插槽 -->
    <div slot="title" class="dialog-title">
      ...
      <div class="left">
        ...
        <el-tag
          ...
          class="tag"
        >
          <el-checkbox v-model="changeState" :disabled="formData.state !== '1'"></el-checkbox>
      ...
      <div class="right">
        <el-popover placement="bottom" trigger="click" ref="popover">
          <div class="popover-button-list">
            ...
            <div
              class="button-item"
              v-if="userInfo.userId === formData.publisher && formData.isWorkshop === '0' && formData.admin"
              @click="handlePublish"
            >同步至工场</div>
          </div>
    ...
    <div class="dialog-content">
      <UpdateTpl class="left" ref="UpdateTpl" @load_page="update_submit"></UpdateTpl>
      <DynamicTpl class="right" :taskId="formData.id" ref="dynamic"></DynamicTpl>
    </div>
  </el-dialog>
</template>
...
export default {
  components: { UpdateTpl, DynamicTpl },
  data() {
    return {
      dialogShow: false,
...
.left ::v-deep .status .time .el-date-editor .el-input__inner {
  padding-left: 15px;
}
</style>
