<template>
  <iep-basic-container class="router-box">
    <iep-page-header :title="pageName" :backOption="backOption">
      <template slot="left">
        <iep-tip
          content="组织信用是节能宝平台依据组织在平台中的各项行为数据，运用云计算和机器学习等技术，对各维度数据进行综合处理和评估，在基本信息、组织人力、履约能力、组织运营能力和历史信用五个维度客观呈现组织信用状况的综合分值。致力于解决用户与组织，组织与组织之间的信任问题，构建互惠互信的节能宝世界。"
        ></iep-tip>
      </template>
    </iep-page-header>
    <div class="wrap">
        ...
        <div class="dashboard">
          ...
          <div class="detail-wrap">
            ...
            <div>
              信用值等级说明
              <iep-tip
                content="节能宝新组织初始信用值为500分，之后随着组织的行为而变化。组织信用主要分为五个层级：<br>
                信用极好：1701-2000分；<br>
                信用优秀：1401-1700分；<br>
                信用良好：1101-1400分；<br>
                信用中等：801-1100分；<br>
